...
Program:
    This program processes text files, counting the occurrence of each word pair, and then prints
...
Hash table: 
    The hash table requires the user to modify the struct _Data object in the hash.h header file to 
